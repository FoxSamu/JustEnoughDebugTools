...
//public class DebugGameTestServer1 extends MinecraftServer {
...
//
//    public DebugGameTestServer1(Thread mainThread, File serverDir, LevelStorageSource.LevelStorageAccess storage, PackRepository packRepo, ServerResources resources, RuntimeTestConfig config, RegistryAccess.RegistryHolder registries) {
//        this(
...
//    }
//
//    private DebugGameTestServer1(Thread mainThread, File serverDir, LevelStorageSource.LevelStorageAccess storage, PackRepository packRepo, ServerResources resources, RuntimeTestConfig config, RegistryAccess.RegistryHolder registries, Registry<Biome> biomes, Registry<DimensionType> dimensions) {
//        super(
