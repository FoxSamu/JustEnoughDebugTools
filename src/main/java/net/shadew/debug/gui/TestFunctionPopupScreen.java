...
public class TestFunctionPopupScreen extends VerticallyStackedScreen {
    private static final TranslatableComponent TITLE = new TranslatableComponent("gui.debug.test_query.function");
    ...
    public TestFunctionPopupScreen(Screen parentScreen, BiConsumer<String, Integer> handler) {
        super(TITLE, parentScreen);

        minecraft = Minecraft.getInstance();
        font = minecraft.font;

        editBox = new CompletableEditBox<>(font, 0, 0, 200, 20, Component.nullToEmpty(""), suggestionsLayer, TestFunctionArgument.testFunctionArgument());
        addWidget(editBox);
